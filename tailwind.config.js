...
module.exports = {
  // configuring purge option with paths to all of my components so that Tailwind can tree-shake unused styles in prod builds
  ...
  theme: {
    ...
    backgroundImage: {
      ...
      "great-hall": "url('/images/great-hall-v2.png')",
    },
